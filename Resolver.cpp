...
static pintool::unordered_map<ADDRINT, pintool::unordered_set<ADDRINT> > indirect_branches;
...
static pintool::unordered_map<ADDRINT, pintool::unordered_set<ADDRINT> > vtables;

// Build a set of all the functions called by the program.
static PIN_LOCK functions_lock;
static pintool::unordered_map<ADDRINT, pintool::unordered_set<ADDRINT> > direct_branches;

// Build a set of all the insteresting instructions.
static PIN_LOCK interesting_ins_lock;
static pintool::unordered_set<ADDRINT> interesting_ins;
